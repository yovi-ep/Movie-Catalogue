...
class MovieFavoriteFm : BaseFragment<FavoriteViewModels>() {
    ...
    private fun loadData() {
        onShowProgressbar()
        viewmodel?.allMovie?.observe(this, setMovies)
        onHideProgressbar()
    }

    private val setMovies = Observer<MutableList<MovieFavorite>> {
